...
* Более надёжный трекинг (multi-object tracking)
* Unit & integration tests для критичных модулей
* Конфигурируемая система плагинов для добавления новых зон/стратегий
* Контейнеризация/CI сборка для автоматического тестирования (Windows runners)
* Документация формата: How-to videos, GIFs, простые сценарии запуска
...
2. Создайте feature-ветку `feature/your-change`
3. Откройте Pull Request с описанием изменений

Пожалуйста, перед PR опишите: цель изменения, как это тестировать и возможные регрессии.

---

## License

По умолчанию указана MIT-совместимая заметка. При желании замените на конкретную лицензию в `LICENSE`.

---

## Контакты

* GitHub: `https://github.com/KAfus1231/DIABLO_2_BOT`
